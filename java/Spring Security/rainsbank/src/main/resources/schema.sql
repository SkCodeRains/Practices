...
DROP TABLE IF EXISTS `practice`.`account_transactions`, `practice`.`accounts`, `practice`.`cards`, `practice`.`contact_messages`, `practice`.`customer`, `practice`.`loans`, `practice`.`notice_details`;
...
CREATE TABLE `customer` (
  ...
  `create_dt` date DEFAULT NULL,authorityauthority
