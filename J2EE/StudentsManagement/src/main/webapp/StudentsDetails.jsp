		...
		<table class="table-responsive table-borderless  table  w-100">
			...
			<tr>
				...
				<td>
					...
					class="btn float-right mr-5 align-bottom align-bottom position-relative btn-danger align-items-center"
					value="Delete" onclick="rejectReq(this)">Reject Admission
						Request</button>
				</td>
			</tr>
		</table>
